      ...
      <div className="mx-auto w-full max-w-6xl">
        <div className="animate-pulse space-y-6">
          <div className="rounded-[2rem] border border-site-line bg-site-surface p-8">
            <div className="h-4 w-32 rounded-lg bg-site-line" />
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {Array.from({ length: 6 }).map((_, i) => (
              ...
              >
                <div className="h-4 w-16 rounded-lg bg-site-line" />
                <div className="mt-3 h-6 w-3/4 rounded-lg bg-site-line" />
                <div className="mt-2 h-4 w-full rounded-lg bg-site-line" />
              </div>
            ))}
          </div>
        </div>
